...
```
```{r setwd_source, warning=F, echo=FALSE, message=FALSE, cache=T, results='hide', include=FALSE, error=F, dependson='rscripts/8_visuals.r'}
...
For our classification tree, We found a CV prediction error rate of `r round(tree_err_rate,3)`, sensitivity of `r round(tree_sens,3)`, specificity of `r round(tree_spec, 3)`, and a AUC of `r round(tree_auc, 3)` (figure 1, table 2). This showed a considerably higher degree of accuracy compared with the logistic regression models that were produced. 
