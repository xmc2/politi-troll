...
```
  ...
  __Figure 2__ Pruned regression tree visualization. Nodes indicate, prediction (0 or 1 for troll status), mean troll value, and percentage of data contained in each node. Variables present in the pruned classification tree include: 
...
### Reproducibility
Because of the subjective nature of troll classifcation this project will not be completely reproducible. There are several reproducibility issues ti i n this project inlucding username and tweet collection as well as troll classificaiton. 
