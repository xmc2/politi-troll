...
using a simple logistic regression we found a prediction error of `r 1-round(error_log1, 2)` and including more relevant variables `r 1-round(error_log2, 2)`
...
Thank you to http://unicode.org/emoji/charts/full-emoji-list.html for letting me borrow that 