...
Our best performing model did not classify well (results). However, this study did shed light onto a strange phenomina of different classes of trolls. From our observation, there seemed to be three main types of twitter trolls.
...
troll/fan pages: these accounts seem to be semi autonomous as they respond to policial figures (@therealdonaldtrmp, @hillaryclinton) almost instantaniously while also seeming to be able to respond to certian accounts in a thought out manner. these accounts unlike the previous two have many tweets, were created long ago and have many followers. 
