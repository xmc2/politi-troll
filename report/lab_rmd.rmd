...
Data was collected from twitter using both the Twitter API and web app. Initial data collection consisted of both searching twitter for political names (ie. clinton, trump), and manual troll harvest. In total, around 2000 tweets from 271 individual accounts were assessed and catororized.
...
boxplot(t_sent ~ data$troll, data=data, col="blue", xlab="Troll", ylab="sentiment score",
