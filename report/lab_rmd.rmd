...
Data was collected from twitter using both the Twitter API and web app. Initial data collection consisted of both searching twitter for political names (ie. clinton, trump), and manual troll harvest.
